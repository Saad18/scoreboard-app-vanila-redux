      ...
      return {
        ...
        matches: state.matches.map((match) =>
          match.id === action.payload
            ? {
              ...match,
              score: match.score + action.value
            } : match
        ),
      }
...
const renderMatches = () => {
  ...
  if (matches) {
    ...
    //Create single match element
    const matchElement = document.createElement("div");
      // matchElement.className = "match"; // correct
      matchElement.classList.add("match"); // correct

    //Create Wrapper element
    const wrapperElement = document.createElement("div");
      // wrapperElement.classList.add("wrapper"); //correct
      wrapperElement.className = "wrapper"; // correct
    ...
    incrementForm.innerText = "Increment";

    //create increment input field
